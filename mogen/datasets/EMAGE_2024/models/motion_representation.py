...
class VQVAEConvZeroEMA(nn.Module):
    def __init__(self, args):
        super(VQVAEConvZeroEMA, self).__init__()
        self.encoder = VQEncoderV5(args)
        self.quantizer = EMAQuantizer(args.vae_codebook_size, args.vae_length, args.vae_quantizer_lambda)
        self.decoder = VQDecoderV5(args)
