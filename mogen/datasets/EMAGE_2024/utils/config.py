...
def parse_args():
    ...
    parser.add("--resume_path", default=None, type=str)
...
#    parser.add("--gan_noise_size", default=0, type=int)
    ...
    parser.add("--motioncraft_config", default="configs/EMGAE/align_t2m_s2g_m2d_upper.py", type=str)
    parser.add("--local-rank", default=None, type=int)
