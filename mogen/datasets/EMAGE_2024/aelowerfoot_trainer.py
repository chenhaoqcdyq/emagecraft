...
class CustomTrainer(train_mix.BaseTrainer):
    ...
    def train(self, epoch):
        ...
        for its, dict_data in enumerate(self.train_loader):
            ...
            tar_contact = dict_data["pose"][..., -4:].to(self.rank).float()
            ...
            # tar_pose = tar_pose_raw[:, :, :27].to(self.rank) 
            # tar_contact = tar_pose_raw[:, :, 27:31].to(self.rank) 
            ...
            if self.args.rec_ver_weight > 0:
                ...
                joints_rec = vertices_rec_joints
